...
<head>
  ...
  <title>BUSKIPM - Sistem Informasi Laboratorium</title>
...
<body class="nav-md">
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>SIMLAB</span></a>
          </div>
          ...
          <div class="profile">
            <div class="profile_pic">
              <img src="<?php echo base_url(); ?>assets/template/images/img.jpg" alt="..." class="img-circle profile_img">
            </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="<?php echo base_url(); ?>assets/template/images/img.jpg" alt="">John Doe
              ...
              <li role="presentation" class="dropdown">
                ...
                <ul id="menu1" class="dropdown-menu list-unstyled msg_list animated fadeInDown" role="menu">
                  <li>
                    <a>
                      <span class="image">
                                        <img src="<?php echo base_url(); ?>assets/template/images/img.jpg" alt="Profile Image" />
                                    </span>
                      <span>
      ...
      <div class="right_col" role="main">
        ...
        <footer>
          <div class="copyright-info">
            <p class="pull-right">BUSKIPM SIMLAB - Sistem Informasi Laboratorium 2016
            </p>
          </div>
          <div class="clearfix"></div>
        </footer>
  ...
  <script src="<?php echo base_url(); ?>assets/template/js/progressbar/bootstrap-progressbar.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/template/js/nicescroll/jquery.nicescroll.min.js"></script>
  <!-- icheck -->
  ...
  <!-- pace -->
  <script src="<?php echo base_url(); ?>assets/template/js/pace/pace.min.js"></script>
