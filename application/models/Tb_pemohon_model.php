...
class Tb_pemohon_model extends CI_Model
{
	...
	$this->db->or_like('nomor_contact_person', $q);
	$this->db->or_like('status_active', $q);
	$this->db->or_like('user_created', $q);
	$this->db->or_like('date_created', $q);
	$this->db->or_like('user_modified', $q);
...
/* End of file Tb_pemohon_model.php */
/* Location: ./application/models/Tb_pemohon_model.php */
